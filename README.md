  ...
  + [Setup](#setup)
    ...
    - [config.json](#configjson)
      ...
      - [Discord settings](#discord-settings)
        - [The two top values NEEDS to be set, otherwise the bot will not listen to anything](#the-two-top-values-needs-to-be-set-otherwise-the-bot-will-not-listen-to-anything)
...
01. Use a specific command: `/command_name arguments`
...
01. Go to [developer applications](https://discord.com/developers/applications) and log in with your discord account.
02. Click on "New Application" and give it a name.
03. Click on "Bot" in the menu on the left.
04. Click on "Reset Token"
05. Copy the token and save it somewhere safe, you're going to need it later
06. Make sure that that you tick the 3 bottoms checks ([like this](https://github.com/mindriddler/discord-bot/blob/main/assets/bot_settings.jpg?raw=true))
07. Click on "Add Bot" and confirm.
08. Click on "OAuth2"
09. Click on "URL Generator"
...
01. Go to [OpenAI](https://beta.openai.com/) and log in with your OpenAI account.
02. Click on your account in the op right
03. Click on "View API keys"
04. Click on "Create new secret key"
05. Copy the key and save it somewhere safe, you're going to need it later
...
##### The two top values NEEDS to be set, otherwise the bot will not listen to anything
...
01. Clone the repo
02. Rename the file called `.env.template` in the root of the project to `.env`
03. Add the following lines to the file:
...
04. Make your desired changes in `Discord_bot/src/config/config.json`
05. Change your working directory to `Docker`
06. Run `docker-compose up -d`
...
01. Check the [OpenAI API documentation](https://beta.openai.com/docs/) and ensure your API key is set up correctly.
02. Review the [discord.py documentation](https://discordpy.readthedocs.io/en/stable/) for possible issues related to Discord interactions.
03. If you still need help, please create an issue on this repository or contact me through one of the methods provided in the "Contact" section of this README.
